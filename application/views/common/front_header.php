								...
								<div class="edu_nav_items main_menu_wrapper text-right">
									<ul>
										...
										<li class="has_submenu">
											...
											<ul class="sub_menu">
												<li><a href="<?php echo base_url('gallery');?>">fotos</a></li>
												<li><a href="<?php echo base_url('video-gallery');?>">Videos</a></li>
											</ul>
										</li>
										<li><a href="<?php echo base_url('facilities');?>">instalaciones</a></li>
										<li><a href="<?php echo base_url('contact-us');?>">Contacto</a></li>
									</ul>
								</div>
